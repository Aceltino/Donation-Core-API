...
resource "aws_vpc" "main" {
  ...
  tags = { Name = "transparencia-agil-vpc" }
}

resource "aws_internet_gateway" "main" {
  vpc_id = aws_vpc.main.id
  tags   = { Name = "transparencia-agil-igw" }
}
...
resource "aws_subnet" "public" {
  ...
  tags                    = { Name = "transparencia-agil-public-${count.index + 1}" }
}
...
resource "aws_subnet" "private" {
  ...
  availability_zone = var.availability_zones[count.index]
  tags              = { Name = "transparencia-agil-private-${count.index + 1}" }
}
...
resource "aws_nat_gateway" "main" {
  ...
  tags          = { Name = "transparencia-agil-nat-${count.index + 1}" }
}
...
resource "aws_lb_target_group" "internal" {
  name        = "transparencia-agil-internal-tg"
  port        = 3000
  protocol    = "HTTP"
  vpc_id      = aws_vpc.main.id
  target_type = "ip"
